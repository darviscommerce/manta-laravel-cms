...
<div class="container" wire:init="loadTrash">
    ...
    <div class="mt-3 row">
        <div class="col-4">
            <a href="{{ route('manta.users.create') }}" class="btn btn-sm btn-success"><i class="fa-solid fa-circle-plus"></i> Toevoegen</a>
        </div>
        <div class="col-4">
        </div>
        <div class="col-4">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif ($deleteId == null || $deleteId != $item->id)
                            <a href="{{ route('manta.users.update', ['input' => $item->id]) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
